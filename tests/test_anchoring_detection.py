...
from kernel.hypothesis_manager import HypothesisManager
from analytics.anchoring_detector import AnchoringDetector
...
def test_anchoring_detection():
    ...
    patterns = detector.detect(state)

    print("\nDetected Patterns:")
    print(patterns)

    assert len(patterns) == 1
    assert patterns[0]["pattern_id"] == "CP-201"

    print("\nTEST PASSED")


if __name__ == "__main__":
    test_anchoring_detection()
